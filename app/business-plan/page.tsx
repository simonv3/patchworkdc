  ...
  return (
    <div className="flex flex-col gap-6 rounded-lg pt-20 flex-1 md:mb-20">
      ...
      <p>
        ...
        which allows us to put down 10%, making our downpayment $26,500. We will
        be using the next two months to be raising capital to decrease the loan
        and annual payment.
      </p>
      <FinancialTable
        rows={[
      ...
      />
      <p>
        These are the numbers assumed in our budget spreadsheet. Of course, the
        more we raise for the downpayment, the better off we will be. The main
        thing to flag about this property is the high condo fee and the special
        assessment that was implemented to raise capital reserves for future
        sustainability of the property. Financial assessment of capital reserves
        of the property available upon request.
      </p>
      <DonateButton artist={artist} />
      ...
      <p>
        Member dues most closely align our mission with where the revenue comes
        from, it also has the most capacity for revenue growth, as it doesn't
        face the square-footage limitations that most other revenue streams do.
      </p>
      <ul className="list-disc pl-6 space-y-1">
        <li>
        ...
        <li>
          ...
          25% at a $25/mo rate, 22% at a $60/mo rate, and 27% at a $120/mo rate.
        </li>
      </ul>
      <p>Justification:</p>
      <ul className="list-disc pl-6 space-y-1">
        <li>
          ...
          summer camps, were on the board of the DC Tool Library, helped started
          the Greens and Beans grocery co-operative, and have run numerous
          successful membership and fundraising drives for Ward 2 Mutual Aid and
          have extensive relationships across D.C.'s organizing scene.
        </li>
        <li>
        ...
        <li>
          ...
          goals that we think are conservative compared to the potential of the
          space.
        </li>
      </ul>
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li>
          <strong>Assumptions:</strong> Our market research has shown us that a
          going rate in D.C. for small offices in co-working spaces is roughly
          $30/square foot, which for an 80 square foot office, translates to
          $2400/mo. Patchwork plans to charge a rate of $1200/mo total for an
          250 square foot office which includes all the many benefits of a
          managed coworking space for a niche type of organization as listed
          below. Which is a much lower rate than sq foot.
        </li>
      </ul>
      <p>Justification:</p>
      <ul className="list-disc pl-6 space-y-1">
        <li>
          ...
          access, risograph printing and other creative design support, commons
          access, cultural activation and programming by Patchwork, and have
          built-in cross-pollination and member-recruitment funnels for their
          own organizations by being a part of Patchwork. All of these are
          substantial differentiators from co-working spaces like WeWork for the
          right organization.
        </li>
        <li>
          Co-operators of Patchwork are actively working on developing a grocery
          co-operative and a band practice space. They already have a committed
          customer base and are limited by the current space available.
        </li>
        <li>
      ...
      <p>
        D.C. lacks affordable artist studios for young, poor, working-class, and
        emerging artists. Patchwork helps fill this gap.
      </p>
      <ul className="list-disc pl-6 space-y-1">
        <li>
          <strong>Goal:</strong> $1,000/mo in total artist studio rent (1 artist
          studio)
        </li>
        <li>
          <strong>Assumptions:</strong> Going rates for artist studios in D.C.
          are significantly higher than our planned $1000/mo. Equivalent spaces
          like the O Street Studios are much smaller for the same price point.
          This allows us to cater to select working-class artists and provide
          them with the space and resources to do their work.
        </li>
      </ul>
      <p>Justification:</p>
      <ul className="list-disc pl-6 space-y-1">
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li>
          <strong>Assumptions:</strong> Going rates for practice spaces in D.C.
          are around $38/hour. Our $30/hour is competitive with this and allows
          us to cater to local musicians and provide them with the space and
          resources to do practice their art. To respect our neighbors, we aim
          to only offer practice times during the afternoon and early evening.
        </li>
        <li>
          <strong>Risks:</strong> if it's not possible to turn one of the
          smaller offices into a music practice space because of limitations in
          sound proofing (for which we have budgeted $30,000), we will lease the
          space to another Resident Organization.
        </li>
      </ul>
      <p>Justification:</p>
      <ul className="list-disc pl-6 space-y-1">
        <li>
          We have a number of bands who have expressed interest in using a local
          affordable practice studio.
        </li>
      </ul>
      <FullWidthImage
        src="/patches-2.png"
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li>
          ...
          deemed their reserve funds to be relatively low for where they need to
          be. The building seems to be taking corrective action, but we need
          more information. Condo fees don't tend to go down either, but our
          budgeted expenses and revenue streams account for a buffer here.
        </li>
        <li>
          Managing seven different service lines (studio, practice space, co-op,
          tool library, etc.) from Day 1 is a lot of work. However, our worker
          members have a lot of experience through their organizing with space
          management and co-ordinating across several groups.
        </li>
        <li>
          Music practice space in a condo building is a potential conflict. Even
          with limited hours, soundproofing will be expensive and may never be
          sufficient. Likewise, providing up to a hundred community and grocery
          members access to the space could cause potential conflict with the
          building management. We hope to alleviate this by doing outreach to
          the building residents and inviting them to become active participants
          in the space.
        </li>
        <li>
          Raising $411k, in a combination of donations, loans, and other funding
          sources, for a startup is a large task. The 10% down payment and
          commercial loan are expensive. The more we can chip away at this from
          community funding, loans, and donations, the better.
        </li>
      </ul>
      <DonateButton artist={artist} />
    </div>
